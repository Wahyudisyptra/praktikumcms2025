        ...
        <div class="card shadow border-0">
            ...
            <div class="card-body">
                ...
                <form action="{{ route('register.process') }}" method="POST">
                    ...
                    <div class="mb-3 position-relative">
                        ...
                        <div class="input-group">
                            ...
                            <span class="input-group-text" onclick="togglePassword('register-password-confirm', this)" style="cursor:pointer;">
                                <i class="fa fa-eye"></i>
                            </span>
                        </div>
                    </div>
                ...
                <div class="mt-3 text-center">
                    <small>Sudah punya akun? <a href="{{ route('login') }}" class="text-primary fw-bold" style="text-decoration: underline;">Login</a></small>
                </div>
            </div>
        </div>
    </div>
